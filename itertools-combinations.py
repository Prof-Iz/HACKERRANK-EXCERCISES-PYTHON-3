...
Input = Input.split(" ") #Takes user input and splits it into list based on delimiter
S = Input[0].upper() #first index of list is S and makes it upper case
k = int(Input[1]) #second index of list is k, make integer as it is defaluting to string
